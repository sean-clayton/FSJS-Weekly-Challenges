...
$('.flash-card').on('mouseover', function() {
  $(this).find('.answer').show()
}).on('mouseout', function() {
  $('.cheat-button').text() !== 'Cheater!' && $(this).find('.answer').hide()
})
...
var text = $('.cheat-button').text()
$('.cheat-button').click(function() {
  $('.answer').toggle()
  $('.answer').is(':visible') ? $('.cheat-button').text('Cheater!') : $('.cheat-button').text(text)
})
